...
class PrimeActionClient(Node):
    ...
    def __init__(self):
        ...
        self._action_client = ActionClient(self, Prime, 'prime')
    ...
    def get_result_callback(self, future):
        ...
        self.get_logger().info('Result: {0}'.format(result.list))
        rclpy.shutdown()

    def feedback_callback(self, feedback_msg):
        feedback = feedback_msg.feedback
        self.get_logger().info('Received feedback: {0}'.format(feedback.partial_list))
